                ...
                <div className="space-y-6">
                    {
                        reviews.length > 0 ?
                            ...
                            <div className="flex flex-col items-center justify-center p-8 bg-white rounded-2xl border border-[#09080f]/10 ">
                                <h3 className="text-4xl font-bold text-[#8b34d3] mb-4">No reviews available</h3>
                                ...
                                <span className='rounded-2xl my-5 underline px-4 text-[#8b34d3] text-2xl font-bold'>Click Star icons on product details to add reviews</span>
                                <p className='font-bold mt-4'>currently {reviews.length} reviews</p>
